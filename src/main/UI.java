...
public class UI {
    ...
    public UI(GamePanel gp) {
        ...
        Object crystal = new OBJ_ManaPotion(gp);
        crystal_full = crystal.image;
        crystal_blank = crystal.image2;

        Object bronzeCoin = new OBJ_Coin_Bronze(gp,1);
    ...
    public void draw(Graphics2D g2) {
        ...
        if (gp.gameState == gp.characterState) {
            drawCharacterScreen();
            drawPlayerInventory(gp.player, true, 0, 0);
        }
    ...
    public void drawMonsterLife()
    {
            for (int i = 0;i<gp.monster[1].length;i++)
            {
                    ...
                    Monster monster = gp.monster[gp.currentMap][i];
    ...
    public void drawPlayerInventory(Player entity, boolean cursor, int x, int y) {
    ...
    public void drawNPCInventory(NPC entity, boolean cursor, int x, int y) {
    ...
    public void drawSkillInventory(Player entity, boolean cursor) {
        int frameX = 0;
        int frameY = 0;
        int frameWidth = 0;
        int frameHeight = 0;
    ...
    public void trade_buy() {
        ...
        drawPlayerInventory(gp.player, false, gp.tileSize*3, 0);

        // DRAW NPC INVENTORY
        drawNPCInventory(npc, true, 0, 0);
    ...
    public void trade_sell() {
        // DRAW PLAYER INVENTORY
        drawPlayerInventory(gp.player, true, -gp.tileSize*7, 0);
